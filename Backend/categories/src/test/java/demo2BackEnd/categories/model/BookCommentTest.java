...
public class BookCommentTest {
    ...
    public BookCommentTest(long id, String username, String password, String email, String pic, String gender, boolean banned, boolean isComment) {
        this.id = id;
    ...
    public void mv_comment_test1() throws Exception{
        User usr = new User();
        BookCategory mv = new BookCategory();
        BookComment mvc = new BookComment();
        mvc.setUser(usr);
        mvc.setBook(mv);
        mvc.setId(1l);
        assertEquals(1l, (long)mvc.getId());
        assertNotNull(mvc.getUser());
        assertNotNull(mvc.getBook());
    }
}
