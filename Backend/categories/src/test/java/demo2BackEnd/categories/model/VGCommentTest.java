...
public class VGCommentTest {
    ...
    public VGCommentTest(long id, String username, String password, String email, String pic, String gender, boolean banned, boolean isComment) {
        this.id = id;
    ...
    public void mv_comment_test1() throws Exception{
        User usr = new User();
        VideoGameCategory mv = new VideoGameCategory();
        VideoGameComment mvc = new VideoGameComment();
        mvc.setUser(usr);
        mvc.setVideoGameCategory(mv);
        mvc.setId(1l);
        assertEquals(1l, (long)mvc.getId());
        assertNotNull(mvc.getUser());
        assertNotNull(mvc.getVideoGameCategory());
    }
}
