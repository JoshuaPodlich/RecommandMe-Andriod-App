...
public class GuestTest {
    ...
    public GuestTest(long id, String username, String password, String email, String pic, String gender, boolean banned, boolean isComment) {
        this.id = id;
    ...
    public void mv_comment_test1() throws Exception{
       ...
       Guest guest = new Guest();
        guest.setGuest_id(UUID.randomUUID());
        assertNotNull(guest.getGuest_id());
        guest.setId(11l);
        assertEquals(11l,guest.getId());
    }
}
