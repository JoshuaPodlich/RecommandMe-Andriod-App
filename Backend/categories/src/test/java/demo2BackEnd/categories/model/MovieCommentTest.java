...
public class MovieCommentTest {
    ...
    public MovieCommentTest(long id, String username, String password, String email, String pic, String gender, boolean banned, boolean isComment) {
        this.id = id;
    ...
    public void mv_comment_test1() throws Exception{
        ...
        MovieComment mvc = new MovieComment();
        mvc.setUser(usr);
        mvc.setMovie(mv);
        mvc.setId(1l);
        assertEquals(1l, (long)mvc.getId());
        assertNotNull(mvc.getUser());
        assertNotNull(mvc.getMovie());
    }
}
